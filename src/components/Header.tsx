      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-2 xl:space-x-3">
            ...
            <button
              className="flex items-center justify-center w-10 h-10 border border-gray-200 rounded-lg text-[#194fe8] hover:bg-gray-100 transition-colors"
              title="进入管理后台"
          ...
          <div className="xl:hidden absolute top-16 lg:top-20 left-0 right-0 bg-white shadow-lg border-t border-gray-100 z-50">
            <nav className="px-4 sm:px-6 py-4 space-y-3">
              ...
              <div className="pt-4 border-t border-gray-100 space-y-3">
                ...
                <button
                  className="w-full flex items-center justify-center border border-gray-200 text-[#194fe8] hover:bg-gray-100 font-medium py-3 px-4 rounded-lg transition-all duration-200 text-sm sm:text-base mt-2"
                  title="进入管理后台"
                  onClick={() => window.open('http://localhost:5173/login', '_blank')}
                >
